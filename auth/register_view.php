...
<head>
    ...
    <style>
        body { display:flex; align-items:center; justify-content:center; min-height:100vh; background:var(--bg-base); padding:var(--s3); }
        .reg-box { width:100%; max-width:520px; padding:var(--s5); }
        .reg-title { font-family:'DM Serif Display',serif; font-size:1.8rem; margin-bottom:var(--s1); }
        .reg-sub { color:var(--text-muted); font-size:0.875rem; margin-bottom:var(--s4); }
        ...
        .reg-footer { text-align:center; margin-top:var(--s3); font-size:0.85rem; color:var(--text-muted); }
        .reg-footer a { color:var(--accent-primary); font-weight:600; }
    </style>
</head>
<body>
<div class="card reg-box">
    <h1 class="reg-title">Create Account</h1>
    <p class="reg-sub">Internship Management System · Join as a Student or Company</p>
    ...
    <p class="reg-footer">Already have an account? <a href="/ims/auth/login.php">Sign In</a></p>
</div>
